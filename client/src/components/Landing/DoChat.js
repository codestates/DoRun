...
function DoChat() {
  ...
  useEffect(() => {
    ...
    gsap.to(chatText.current, {
      text: {
        value:
          '같은 크루에 있는 Do Run 메이트들과 간편하게 연락을 주고 받아보세요!',
      },
      duration: 5,
      ease: 'none',
      repeat: -1,
      ...
      <div className="doChat">
        ...
        <div className="doChatBubbles" ref={doChatBubbles}>
          <div className="doChatBubbleLeft" ref={bubbleLeft}>
            <div className="doChatBubbleLeftDots" ref={dotsLeft}>
              ...
            </div>
          </div>
          <div className="doChatBubblesText" ref={chatText}></div>
          <div className="doChatBubbleRight" ref={bubbleRight}>
            <div className="doChatBubbleRightDots" ref={dotsRight}>
              ...
            </div>
          </div>
        </div>
