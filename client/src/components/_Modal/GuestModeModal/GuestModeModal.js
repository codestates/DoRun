    ...
    <>
      {guestMode ? (
        <div className="guestModalWrapper">
          <div className="guestModalCancel" onClick={guestModeCancel}>
            {' '}
            X{' '}
          </div>
          ...
          <div className="guestModeBtns">
            <div className="guestModeYes" onClick={guestModeHandler}>
              {' '}
              동의하고 시작하기
            </div>
            <div className="guestModeNo" onClick={guestModalRegister}>
              {' '}
              회원가입 하러가기
            </div>
          </div>
